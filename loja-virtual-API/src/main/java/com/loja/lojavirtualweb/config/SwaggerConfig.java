...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.loja.lojavirtualweb.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API do projeto Virtual-Store",
                "Esta API é utilizada para documentar o projeto virtual-store",
                "Versão 1.0",
                "",
                new Contact("Marco Antônio", "www.linkedin.com/in/marcoti", "marco-oliveira@live.com"),
